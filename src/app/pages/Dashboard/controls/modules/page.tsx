  ...
  const [moduleEditDisabled, setModuleEditDisabled] = useState(false);
    ...
    const createModulo = async () => {
        ...
        try {
            ...
            const response = await axios.post("https://back-end-birigui.vercel.app/api/module/register", bodyForm, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
    ...
    const editModulo = async () => {
        ...
        try {
            ...
            const response = await axios.put(`https://back-end-birigui.vercel.app/api/module/edit/${selectedModule}`, bodyForm, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
    ...
    const handleDelete = async () => {
        ...
        try {
            await axios.delete(`https://back-end-birigui.vercel.app/api/module/${moduleIdToDelete}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
