...
const ItensPage: React.FC = () => {
    ...
    const fetchItens = async () => {
        ...
        setLoading(true)
        try {
            const response = await axios.get("https://back-end-birigui.vercel.app/api/itens", {
                headers: {
    ...
    const handleDelete = async () => {
        ...
        try {
            await axios.put(`https://back-end-birigui.vercel.app/api/itens/edit/${itensIdToDelete}`, { situacao: "DESATIVADO" }, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
    ...
    const handleSaveEdit = async () => {
        ...
        try {
            ...
            const response = await axios.put(
                `https://back-end-birigui.vercel.app/api/itens/edit/${selectedItem?.cod_item}`,
                formData,
                {
                    headers: {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const response = await axios.post("https://back-end-birigui.vercel.app/api/itens/register", formData, {
                headers: {
                    "Content-Type": "multipart/form-data",
                    Authorization: `Bearer ${token}`,
                },
    ...
    const handleEdit = async (itens: Item) => {
        ...
        try {
            ...
            const unitResponse = await axios.get("https://back-end-birigui.vercel.app/api/unMedida", {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
            ...
            const familyResponse = await axios.get("https://back-end-birigui.vercel.app/api/familia/itens/", {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
