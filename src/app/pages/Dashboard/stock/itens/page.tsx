...
const ItensPage: React.FC = () => {
    ...
    const fetchItens = async () => {
        ...
        setLoading(true)
        try {
            const response = await axios.get("http://217.196.61.199:9009/api/itens", {
                headers: {
    ...
    const handleDelete = async () => {
        ...
        try {
            await axios.put(`http://217.196.61.199:9009/api/itens/edit/${itensIdToDelete}`, { situacao: "DESATIVADO" }, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
    ...
    const handleSaveEdit = async () => {
        ...
        try {
            ...
            const response = await axios.put(
                `http://217.196.61.199:9009/api/itens/edit/${selectedItem?.cod_item}`,
                formData,
                {
                    headers: {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const response = await axios.post("http://217.196.61.199:9009/api/itens/register", formData, {
                headers: {
                    "Content-Type": "multipart/form-data",
                    Authorization: `Bearer ${token}`,
                },
    ...
    const handleEdit = async (itens: Item) => {
        ...
        try {
            ...
            const unitResponse = await axios.get("http://217.196.61.199:9009/api/unMedida", {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
            ...
            const familyResponse = await axios.get("http://217.196.61.199:9009/api/familia/itens/", {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
    ...
    const fetchFamilias = async () => {
        setLoading(true);
        try {
            const response = await axios.get("http://217.196.61.199:9009/api/familia/itens/", {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
