...
const FamilyPage: React.FC = () => {
    ...
    const createItem = async () => {
        ...
        try {
            ...
            const response = await axios.post("http://217.196.61.199:9009/api/familia/itens/register", bodyForm, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
    ...
    const editItem = async () => {
        ...
        try {
            ...
            const response = await axios.put(`http://217.196.61.199:9009/api/familia/itens/edit/${selectedFamilia}`, bodyForm, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
    ...
    const handleDelete = async () => {
        ...
        try {
            await axios.delete(`http://217.196.61.199:9009/api/familia/itens/${familiaIdToDelete}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
