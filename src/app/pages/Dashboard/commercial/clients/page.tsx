            ...
            <div className="flex justify-center">
                ...
                <div className="bg-grey pt-3 pl-1 pr-1 w-full h-full rounded-md">
                    ...
                    <div className="bg-white rounded-lg p-8 pt-8 shadow-md w-full flex flex-col" style={{ height: "95%" }}>
                        ...
                        >
                            <Column field="cod_cliente" header="Código" style={{
                                width: "0%",
                                textAlign: "center",
                            ...
                            <Column field="nome" header="Nome Completo" style={{
                                width: "1%",
                                textAlign: "center",
                                border: "1px solid #ccc",
                            }}
                            ...
                            <Column field="tipo" header="Tipo" style={{
                                width: "1%",
                                textAlign: "center",
                                border: "1px solid #ccc",
                            }}
                            ...
                            <Column field="email" header="E-mail" style={{
                                width: "0%",
                                textAlign: "center",
                                border: "1px solid #ccc",
                            }}
                            ...
                            <Column field="celular" header="Celular" style={{
                                width: "1%",
                                textAlign: "center",
                                border: "1px solid #ccc",
                            }}
                            ...
                            <Column field="telefone" header="Telefone" style={{
                                width: "1%",
                                textAlign: "center",
                                border: "1px solid #ccc",
                            }}
                            ...
                            <Column field="dt_hr_criacao" header="DT Cadastro" style={{
                                width: "1%",
                                textAlign: "center",
                                border: "1px solid #ccc",
                            }}
                            ...
                            <Column
                                ...
                                body={(rowData) => (
                                    <div className="flex gap-2 justify-center">
                                        <button onClick={() => openDialog(rowData.cod_cliente)} className="bg-red text-black p-1 rounded">
